...
var KTCardsWidget1 = {
    init: function () {
        !function () {
            ...
            if (e) {
                var t = e.getAttribute("data-kt-chart-color"), a = parseInt(KTUtil.css(e, "height")),
                    r = KTUtil.getCssVariableValue("--bs-gray-500"),
                    o = KTUtil.isHexColor(t) ? t : KTUtil.getCssVariableValue("--bs-" + t),
                    i = KTUtil.getCssVariableValue("--bs-gray-300"), s = new ApexCharts(e, {
                        series: [{
                            name: "Net Profit",
    ...
    init: function () {
        !function () {
            ...
            if (e) {
                ...
                a.width = a.height = t.size, e.appendChild(r), e.appendChild(a), o.translate(t.size / 2, t.size / 2), o.rotate((t.rotate / 180 - .5) * Math.PI);
                var i = (t.size - t.lineWidth) / 2, s = function (e, t, a) {
                    a = Math.min(Math.max(0, a || 1), 1), o.beginPath(), o.arc(0, 0, i, 0, 2 * Math.PI * a, !1), o.strokeStyle = e, o.lineCap = "round", o.lineWidth = t, o.stroke()
                };
...
var KTCardsWidget6 = {
    init: function () {
        !function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")), a = KTUtil.getCssVariableValue("--bs-gray-500"),
        ...
        !function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    r = KTUtil.getCssVariableValue("--bs-light-info"), o = new ApexCharts(e, {
                        series: [{
                            name: "Net Profit",
        ...
        !function () {
            ...
            if (e) {
                var t = e.hasAttribute("data-kt-negative-color") ? e.getAttribute("data-kt-negative-color") : KTUtil.getCssVariableValue("--bs-success"),
                    a = parseInt(KTUtil.css(e, "height")), r = KTUtil.getCssVariableValue("--bs-gray-500"),
                    o = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    i = KTUtil.getCssVariableValue("--bs-primary"), s = new ApexCharts(e, {
                        series: [{
                            name: "Net Profit",
...
var KTChartsWidget11 = function () {
    var e = function (e, t, a, r) {
        var o = document.querySelector(t), i = parseInt(KTUtil.css(o, "height"));
        if (o) {
            var s = KTUtil.getCssVariableValue("--bs-gray-500"),
                l = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                n = KTUtil.getCssVariableValue("--bs-success"), d = KTUtil.getCssVariableValue("--bs-success"),
                c = new ApexCharts(o, {
                ...
                }), u = !1, p = document.querySelector(e);
        ...
        !function () {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    var r = [{year: "2003", cars: 1587, motorcycles: 650, bicycles: 121}, {
                            year: "2004",
                            cars: 1567,
                            motorcycles: 683,
                            bicycles: 146
                        ...
                        o = a.xAxes.push(am5xy.CategoryAxis.new(t, {
                            categoryField: "year",
                            startLocation: .5,
                            endLocation: .5,
                    ...
                    var i = a.yAxes.push(am5xy.ValueAxis.new(t, {renderer: am5xy.AxisRendererY.new(t, {})}));
                    ...
                    function s(e, s, l) {
                        ...
                        n.fills.template.setAll({fillOpacity: .5, visible: !0}), n.data.setAll(r), n.appear(1e3)
                    }
                    ...
                    var l = o.makeDataItem({category: "2016", endCategory: "2021"});
                    o.createAxisRange(l), l.get("grid").setAll({
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    var a = t.container.children.push(am5radar.RadarChart.new(t, {
                        ...
                        value: 80,
                        full: 100,
                        columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-info"))}
                    }, {
                        category: "Marketing",
                        value: 35,
                        full: 100,
                        columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-danger"))}
                    }, {
                        category: "Distribution",
                        value: 92,
                        full: 100,
                        columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))}
                    }, {
                        category: "Human Resources",
                        value: 68,
                        full: 100,
                        columnSettings: {fillOpacity: 1, fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}
                    }];
                    a.set("cursor", am5radar.RadarCursor.new(t, {behavior: "zoomX"})).lineY.set("visible", !1);
                    var o = am5radar.AxisRendererCircular.new(t, {});
                    o.labels.template.setAll({radius: 10}), o.grid.template.setAll({forceHidden: !0});
                    var i = a.xAxes.push(am5xy.ValueAxis.new(t, {
                        renderer: o,
                        min: 0,
                        max: 100,
                        strictMinMax: !0,
                        numberFormat: "#'%'",
                        tooltip: am5.Tooltip.new(t, {})
                    })), s = am5radar.AxisRendererRadial.new(t, {minGridDistance: 20});
                    ...
                    var l = a.yAxes.push(am5xy.CategoryAxis.new(t, {categoryField: "category", renderer: s}));
                    l.data.setAll(r);
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    o.get("renderer").labels.template.setAll({
                        ...
                        fontSize: 13,
                        fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))
                    }), o.get("renderer").grid.template.setAll({disabled: !0, strokeOpacity: 0}), o.data.setAll(r);
                    var i = a.yAxes.push(am5xy.ValueAxis.new(t, {renderer: am5xy.AxisRendererY.new(t, {})}));
                    i.get("renderer").grid.template.setAll({
                        stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")),
                        strokeWidth: 1,
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    var a = t.container.children.push(am5xy.XYChart.new(t, {
                        ...
                        wheelY: "zoomX",
                        layout: t.verticalLayout
                    })), r = (a.get("colors"), [{country: "US", visits: 725}, {
                        country: "UK",
                        visits: 625
                    }, {country: "China", visits: 602}, {country: "Japan", visits: 509}, {
                        country: "Germany",
                        visits: 322
                    }, {country: "France", visits: 214}, {country: "India", visits: 204}, {
                        country: "Spain",
                        visits: 198
                    }, {country: "Italy", visits: 165}, {country: "Russia", visits: 130}, {
                        country: "Norway",
                        visits: 93
                    ...
                    !function () {
                        ...
                        var o = 0;
                        for (t = 0; t < r.length; t++) o += a = r[t].visits, r[t].pareto = o / e * 100
                    }();
                    ...
                    var s = am5xy.AxisRendererY.new(t, {opposite: !0}),
                        l = a.yAxes.push(am5xy.ValueAxis.new(t, {renderer: s, min: 0, max: 100, strictMinMax: !0}));
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    a.labels.template.setAll({
                        ...
                        startAngle: 180,
                        endAngle: 180
                    }), a.slices.template.setAll({cornerRadius: 5}), a.ticks.template.setAll({forceHidden: !0}), a.data.setAll([{
                        value: 10,
                        category: "One",
                        fill: am5.color(KTUtil.getCssVariableValue("--bs-primary"))
                    }, {
...
var KTChartsWidget2 = {
    init: function () {
        ...
        e = document.querySelectorAll(".charts-widget-2"), [].slice.call(e).map((function (e) {
            var t = parseInt(KTUtil.css(e, "height"));
            if (e) {
                var a = e.getAttribute("data-kt-chart-color"), r = KTUtil.getCssVariableValue("--bs-gray-800"),
                    o = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
...
var KTChartsWidget5 = {
    init: function () {
        !function () {
            ...
            if (e) {
                var t = KTUtil.getCssVariableValue("--bs-border-dashed-color"), a = {
        ...
        !function () {
            ...
            if (e) {
                var t = KTUtil.getCssVariableValue("--bs-gray-800"),
                    a = KTUtil.getCssVariableValue("--bs-border-dashed-color"), r = new ApexCharts(e, {
                        ...
                        dataLabels: {
                            enabled: !0, textAnchor: "start", offsetX: 0, formatter: function (e, t) {
                                return e *= 1e3, wNumb({thousand: ","}).to(e)
                        ...
                        xaxis: {
                            ...
                            labels: {
                                formatter: function (e) {
                                    return e + "K"
                                }, style: {colors: t, fontSize: "14px", fontWeight: "600", align: "left"}
                            },
                            axisBorder: {show: !1}
                        },
                        yaxis: {
                            labels: {
                                ...
                                }, style: {colors: t, fontSize: "14px", fontWeight: "600"}, offsetY: 2, align: "left"
                            }
                        },
...
var KTChartsWidget7 = function () {
    var e = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), o = {
                ...
                colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-light-primary")],
                grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: !0}}}
            }, i = new ApexCharts(t, o), s = !1, l = document.querySelector(tabSelector);
            !0 === initByDefault && (i.render(), s = !0), l.addEventListener("shown.bs.tab", (function (e) {
                0 == s && (i.render(), s = !0)
...
var KTChartsWidget8 = function () {
    var e = function (e, t, a, r) {
        var o = document.querySelector(t);
        if (o) {
            var i = parseInt(KTUtil.css(o, "height")), s = KTUtil.getCssVariableValue("--bs-border-dashed-color"), l = {
            ...
            }, n = !1, d = new ApexCharts(o, l), c = document.querySelector(e);
...
var KTChartsWidget9 = {
    init: function () {
        !function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")), a = KTUtil.getCssVariableValue("--bs-gray-400"),
                    r = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
        ...
        !function () {
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    }), r.mapPolygons.template.states.create("hover", {fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))}), r.mapPolygons.template.states.create("active", {fill: am5.color(KTUtil.getCssVariableValue("--bs-success"))});
                    var o = a.series.push(am5map.MapPolygonSeries.new(t, {
                        geoJSON: am5geodata_worldLow,
                        include: ["US", "BR", "RU"]
                    }));
                    o.mapPolygons.template.setAll({
                        ...
                        toggleKey: "active",
                        interactive: !0
                    }), am5.ColorSet.new(t, {}), o.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))), o.mapPolygons.template.states.create("hover", {fill: t.interfaceColors.get("primaryButtonHover")}), o.mapPolygons.template.states.create("active", {fill: t.interfaceColors.get("primaryButtonHover")}), a.chartContainer.get("background").events.on("click", (function () {
                        a.goHome()
                    })), a.appear(1e3, 100)
                }))
            }
            ...
            (e = document.querySelector("#kt_widget_table_3")) && (t = $(e).DataTable({
                ...
                e.forEach((r => {
                    r.addEventListener("click", (o => {
                        ...
                        })), r.classList.remove("text-muted"), r.classList.add(...a), "Show All" === i ? t.search("").draw() : t.search(i).draw()
                    }))
                }))
            })(), a())
        }
...
var KTTablesWidget4 = function () {
    ...
    const r = () => {
        ...
        const e = document.querySelectorAll('[data-kt-table-widget-4="expand_row"]'), t = [3, 1, 3, 1, 2, 1];
        e.forEach(((e, a) => {
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_table_widget_5_table")) && (e.querySelectorAll("tbody tr").forEach((e => {
                const t = e.querySelectorAll("td"), a = moment(t[2].innerHTML, "MMM DD, YYYY").format();
        ...
        document.querySelectorAll('[data-kt-timeline-widget-1="tab"]').forEach((e => {
            e.addEventListener("shown.bs.tab", (t => {
                "#kt_timeline_widget_1_tab_week" === e.getAttribute("href") && (() => {
                    ...
                    var t = Date.now(), a = e.getAttribute("data-kt-timeline-widget-1-image-root"),
            ...
            (() => {
                ...
                var t = Date.now(), a = e.getAttribute("data-kt-timeline-widget-1-image-root"),
                    ...
                    o = new vis.DataSet([{
                        ...
                        onInitialDrawComplete: function () {
                            const t = e.closest('[data-kt-timeline-widget-1-blockui="true"]'), a = KTBlockUI.getInstance(t);
                            a.isBlocked() && setTimeout((() => {
                                a.release()
                            }), 1e3)
                        }
